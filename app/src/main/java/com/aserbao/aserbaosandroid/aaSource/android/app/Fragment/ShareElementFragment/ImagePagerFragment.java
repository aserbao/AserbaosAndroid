...
import com.aserbao.aserbaosandroid.aaSource.android.app.Fragment.ShareElementFragment.adapter.ImagePagerAdapter;
...
public class ImagePagerFragment extends Fragment {
  ...
  public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
    ...
    // paging the images.
    viewPager.setCurrentItem(FragmentActivity.currentPosition);
    viewPager.addOnPageChangeListener(new ViewPager.SimpleOnPageChangeListener() {
      @Override
      public void onPageSelected(int position) {
          FragmentActivity.currentPosition = position;
      }
    });
    ...
    setEnterSharedElementCallback(
        new SharedElementCallback() {
          ...
          public void onMapSharedElements(List<String> names, Map<String, View> sharedElements) {
            ...
            int currentPosition = FragmentActivity.currentPosition;
