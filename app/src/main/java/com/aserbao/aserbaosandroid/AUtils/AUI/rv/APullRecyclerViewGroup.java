package com.aserbao.aserbaosandroid.AUtils.AUI.rv;
...
public class APullRecyclerViewGroup extends LinearLayout implements ViewTreeObserver.OnGlobalLayoutListener {
    ...
    public APullRecyclerViewGroup(Context context) {
        this(context, null);
    }

    public APullRecyclerViewGroup(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public APullRecyclerViewGroup(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private static final String TAG = "PullRecyclerViewGroup";
    @Override
