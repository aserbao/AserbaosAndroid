...
public class AppScreenMgr {
    ...
    public static String getScreenInfo(Context context){
        String s = " " ;
        s = " 获得屏幕宽度ScreenWidth  =  "  + getScreenWidth(context) + " \n" +
            " 获得屏幕高度ScreenHeight  =  "  + getScreenHeight(context) + " \n" +
            " 获取整块屏幕的高度  =  "  + getRealScreenHeight(context) + " \n" +
            " 获取导航栏高度  =  "  + getNavigationBarrH(context) + " \n" +
            " 获取虚拟按键区域的高度  =  "  + getNavigationAreaHeight(context) + " \n" +
            " 获得状态栏的高度  =  "  + getStatusHeight(context) + " \n" +
            " 获得标题栏高度  =  "  + getTitleBarHeight((Activity) context) + " \n" +
            " 获取通知栏高度  =  "  + getStatusBarHeight( context) + " \n";
