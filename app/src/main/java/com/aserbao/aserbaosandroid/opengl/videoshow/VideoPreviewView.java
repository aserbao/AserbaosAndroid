 ...
 */
public class VideoPreviewView extends GLSurfaceView implements GLSurfaceView.Renderer, MediaPlayer.OnCompletionListener, MediaPlayer.OnErrorListener, MediaPlayer.OnPreparedListener{
    private static final String TAG = "VideoPreviewView";
    private MediaPlayer mMediaPlayer;
    private VideoGlRender videoGlRender;
    ...
    private void init(Context context) {
        ...
        videoGlRender = new VideoGlRender(context);
        setVideoPath("");
    }
    /**设置视频的播放地址*/
