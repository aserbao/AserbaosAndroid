package com.aserbao.aserbaosandroid.ui.texts.textViews.textShowAnimation.hTextView.fade;
...
public class FadeText extends HText {
    ...
    public void init(HTextView hTextView, AttributeSet attrs, int defStyle) {
        ...
        animationDuration = typedArray.getInt(R.styleable.FadeTextView_fade_animationDuration, DEFAULT_DURATION);
        typedArray.recycle();
    }
