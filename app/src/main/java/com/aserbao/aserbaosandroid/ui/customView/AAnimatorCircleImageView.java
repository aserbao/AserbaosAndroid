...
public class AAnimatorCircleImageView extends ImageView {
    ...
    public AAnimatorCircleImageView(Context context) {
        super(context);

        init();
    }

    public AAnimatorCircleImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public AAnimatorCircleImageView(Context context, AttributeSet attrs, int defStyle) {
