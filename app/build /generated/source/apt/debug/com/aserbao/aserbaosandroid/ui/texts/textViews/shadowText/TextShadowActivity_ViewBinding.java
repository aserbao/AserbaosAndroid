...
public class TextShadowActivity_ViewBinding<T extends TextShadowActivity> implements Unbinder {
  protected T target;

  @UiThread
  public TextShadowActivity_ViewBinding(T target, View source) {
    this.target = target;
    ...
    target.mTbiTvSize = Utils.findRequiredViewAsType(source, R.id.tbi_tv_size, "field 'mTbiTvSize'", TextView.class);
    target.mTextBarItemSeekBarTextSize = Utils.findRequiredViewAsType(source, R.id.text_bar_item_seek_bar_text_size, "field 'mTextBarItemSeekBarTextSize'", SeekBar.class);
  }
  ...
  public void unbind() {
    ...
    target.mTbiTvSize = null;
    target.mTextBarItemSeekBarTextSize = null;
