...
public class LifeCycleActivity_ViewBinding<T extends LifeCycleActivity> implements Unbinder {
  protected T target;
  ...
  @UiThread
  public LifeCycleActivity_ViewBinding(final T target, View source) {
    this.target = target;
