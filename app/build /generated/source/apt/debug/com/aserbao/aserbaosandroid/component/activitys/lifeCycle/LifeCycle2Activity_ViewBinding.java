...
public class LifeCycle2Activity_ViewBinding<T extends LifeCycle2Activity> implements Unbinder {
  protected T target;
  ...
  @UiThread
  public LifeCycle2Activity_ViewBinding(final T target, View source) {
    this.target = target;
